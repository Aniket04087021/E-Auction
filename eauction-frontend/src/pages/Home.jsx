    ...
    <div className="homepage">
      ...
      <section className="hero">
        <div className="hero__container">
          ...
          <p className="hero__subtitle">
            Discover amazing deals, bid on unique items, and experience the
            thrill of online auctions like never before
          </p>
      ...
      <section className="what-is">
        <div className="section__container">
          ...
          <p className="section__subtitle">
            Bid-Sphere is your premier online auction platform where buyers and
            sellers come together to create exciting bidding experiences
          </p>
          ...
          <div className="features-grid">
            <div className="feature-card">
              ...
              <h3>Fast & Secure</h3>
              <p>
                Lightning-fast bidding with bank-level security. Your
                transactions and personal information are always protected with
            ...
            <div className="feature-card">
              ...
              <p>
                Connect with buyers and sellers worldwide. Access unique items
                from different countries and cultures, all from the comfort of
                your home.
              </p>
            </div>
            <div className="feature-card">
              ...
              <p>
                ...
                updates, instant notifications, and competitive bidding that
      ...
      <section id="how-it-works" className="how-it-works">
        <div className="section__container">
          ...
          <p className="section__subtitle">
            Get started with Bid-Sphere in just a few simple steps
          </p>
          ...
          <div className="steps-container">
            <div className="step">
              ...
              <p>
                Create your free account and verify your identity to ensure a
                safe and trusted auction environment for everyone.
              </p>
            </div>
            <div className="step">
              ...
              <p>
                Explore thousands of active auctions across various categories.
            ...
            <div className="step">
              ...
              <p>
                Found something you love? Place your bid and watch the auction
                unfold. Set automatic bids to stay competitive.
              </p>
            </div>
            <div className="step">
              ...
              <h3>Win & Enjoy</h3>
              <p>
                Win the auction and complete your purchase securely. Your item
          ...
          <div className="testimonials-grid">
            <div className="testimonial-card">
              <p className="testimonial-quote">
                "Bid-Sphere has completely changed how I buy collectibles. The
                platform is intuitive, secure, and I've found some amazing deals
            ...
            <div className="testimonial-card">
              <p className="testimonial-quote">
                "As a seller, I appreciate the global reach and the professional
                tools provided. My items get great visibility and the bidding
            ...
            <div className="testimonial-card">
              <p className="testimonial-quote">
                "The real-time notifications and automatic bidding features are
                game-changers. I never miss an opportunity and can bid
                confidently even when I'm busy."
              </p>
              <div className="testimonial-author">
      ...
      <section className="partners">
        <div className="section__container">
          ...
          <p className="section__subtitle">
            We work with leading companies to provide you the best auction
            experience
          </p>
        ...
        <div className="section__container">
          ...
          <div className="about-content">
            <div className="about-text">
              <p>
                Founded in 2020, Bid-Sphere has grown to become one of the most
                trusted online auction platforms globally. We believe that
                everyone should have access to unique items and great deals
                through fair and transparent bidding processes.
              </p>
              <p>
                Our platform combines cutting-edge technology with user-friendly
                design to create an auction experience that's both exciting and
                secure. Whether you're a casual buyer looking for a great deal
                or a serious collector seeking rare items, Bid-Sphere is your
                gateway to the world of online auctions.
              </p>
              <p>
                With advanced security measures, real-time bidding technology,
                and 24/7 customer support, we ensure that every transaction is
                safe, smooth, and satisfying for all parties involved.
              </p>
            </div>
